...
def main():
    ...
    dp.add_handler(CommandHandler('charts', get_candlestick, run_async=True))
    dp.add_handler(CommandHandler('chart', get_candlestick, run_async=True))
    dp.add_handler(CommandHandler('c', get_candlestick, run_async=True))
