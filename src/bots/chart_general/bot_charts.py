...
def main():
    ...
    dp.add_handler(CommandHandler(['biz', 'b'], get_biz))
    dp.add_handler(CommandHandler('convert', do_convert))
    dp.add_handler(CommandHandler(['gas', 'g'], get_gas_average))
    dp.add_handler(CommandHandler('balance', balance_token_in_wallet))
    dp.add_handler(CommandHandler('timeto', get_time_to))
    dp.add_handler(CommandHandler(['last_actions', 'l'], get_latest_actions))
