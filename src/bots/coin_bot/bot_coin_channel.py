...
def main():
    ...
    j.run_repeating(get_twitter, interval=check_tweets_interval_second, first=450)
    j.run_repeating(get_price_token, interval=check_price_interval_second, first=30)
